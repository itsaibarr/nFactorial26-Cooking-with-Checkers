...
const CAPTURE_MODE_OPTIONS: Array<{
  ...
  {
    value: "full_move",
    title: "Полная траектория",
    description: "Как сейчас: вы выбираете сразу весь легальный маршрут взятия.",
  },
  {
    value: "step_by_step",
    title: "Пошаговый выбор",
    description: "Вы выбираете продолжение взятия по шагам, но ход всё равно доводится до конца по правилам.",
  },
]
