...
describe("computeGameSharpness", () => {
  ...
  it("does not keep a mistake-heavy game high just because move timing looks normal", () => {
    const analysis = computeGameSharpness({
      playerColor: "white",
      moves: [
        {notation: "e3-d4", durationMs: 2056},
        ...
        {notation: "f4-e5", durationMs: 3288},
        {notation: "d6:f4", durationMs: null},
        {notation: "f2-e3", durationMs: 2400},
        {notation: "f4:d2", durationMs: null},
        {notation: "c1:e3", durationMs: 1656},
        {notation: "c5-d4", durationMs: null},
        {notation: "e3:c5", durationMs: 1189},
    ...
    expect(analysis.breakdown.speed).toBeGreaterThanOrEqual(60)
    expect(analysis.score).toBeLessThanOrEqual(58)
    expect(analysis.breakdown.blunderRate).toBeLessThanOrEqual(60)
  })
})
